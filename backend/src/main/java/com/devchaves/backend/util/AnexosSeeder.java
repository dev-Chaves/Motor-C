...
public class AnexosSeeder implements ApplicationRunner {
    ...
    private void inserirFaixaDeAnexos() {
        ...
        // --- Anexo I ---
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_1,
                new BigDecimal("0.00"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                ...
                new BigDecimal("0.0730"),
                new BigDecimal("5940.00"),
                dataVigencia));
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_1,
                new BigDecimal("720000.01"),
                new BigDecimal("1800000.00"),
                new BigDecimal("0.1070"),
                new BigDecimal("22500.00"),
                dataVigencia));

        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_1,
                new BigDecimal("1800000.01"),
                new BigDecimal("3600000.00"),
                new BigDecimal("0.1430"),
                new BigDecimal("87300.00"),
                dataVigencia));

        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_1,
                new BigDecimal("3600000.01"),
                new BigDecimal("4800000.00"),
                new BigDecimal("0.1900"),
                new BigDecimal("378000.00"),
                dataVigencia));

        // --- Anexo II ---
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_2, new BigDecimal("0.00"),
                new BigDecimal("180000.00"), new BigDecimal("0.0450"),
                new BigDecimal("0.00"),
                dataVigencia));
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_2, new BigDecimal("360000.01"),
                new BigDecimal("720000.00"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_2, new BigDecimal("720000.01"),
                new BigDecimal("1800000.00"),
                new BigDecimal("0.1120"),
                new BigDecimal("22500.00"),
                dataVigencia));
        ...
        // --- Anexo III ---
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_3, new BigDecimal("0.00"),
                new BigDecimal("180000.00"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_3, new BigDecimal("180000.01"),
                new BigDecimal("360000.00"),
                new BigDecimal("0.1120"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_3, new BigDecimal("360000.01"),
                new BigDecimal("720000.00"),
                new BigDecimal("0.1350"),
                new BigDecimal("17640.00"),
                dataVigencia));

        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_3, new BigDecimal("720000.01"),
                new BigDecimal("1800000.00"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                Anexo.ANEXO_3, new BigDecimal("1800000.01"),
                new BigDecimal("3600000.00"),
        ...
        todasAsFaixas.add(new FaixaAnexo(
                ...
                new BigDecimal("360000.01"),
                new BigDecimal("720000.00"),
                new BigDecimal("0.1020"),
                new BigDecimal("12420.00"),
                dataVigencia));
